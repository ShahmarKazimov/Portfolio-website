...
// Map category icons using confirmed available icons
...
// Flatten all skills into structured chip objects for the Bucket
const ALL_SKILL_CHIPS = skills.flatMap((group, groupIdx) =>
...
const Bucket = ({ chips = ALL_SKILL_CHIPS }) => {
                  ...
                  >
                    <div className="flex size-10 shrink-0 items-center justify-center rounded-full bg-accent/20 text-accent">
                      {chip.icon ? (
                        ...
                        <span className="font-mono text-xs font-bold text-accent">AI</span>
                      )}
                    </div>
