...
const LINE_BASE = { r: 255, g: 255, b: 255, a: 0.16 };
const NODE_BASE_RADIUS = 2;
const NODE_ACTIVE_RADIUS = 3.4;

// Accent lime to match the site palette (--color-accent: #c9ff3a)
const LINE_ACTIVE = { r: 201, g: 255, b: 58, a: 0.85 };
const NODE_ACTIVE = { r: 201, g: 255, b: 58, a: 1 };
const GLOW_RGB = "201,255,58";
const RIPPLE_RGB = "201,255,58";
...
/**
 * Full-page kinetic grid background: a warping dot/line lattice that reacts
 * to the cursor and ripples on click. Fixed behind all content, spans the
 * whole viewport so the effect stays consistent as the user scrolls through
 * sections.
 */
    ...
    (now) => {
      ...
      for (let row = 0; row < rows; row++) {
        for (let col = 0; col < cols; col++) {
          ...
          ctx.fillStyle = lerpColor({ r: 255, g: 255, b: 255, a: 0.08 }, NODE_ACTIVE, t);
          ctx.fill();
        }
      }
